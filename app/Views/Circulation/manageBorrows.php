...
<header>
    ...
    <div class="modal-overlay" id="returnModal">
        <div class="modal-box">
            ...
            <div class="fine-preview" id="finePreview"></div>
            <div class="modal-btns">
    ...
    <div class="modal-overlay" id="claimPopup">
        <div class="modal-box">
            ...
            <div class="modal-btns">
                ...
                <button class="btn btn-ghost" onclick="closeClaimPopup()">Close</button>
            </div>
        </div>
    </div>
    ...
    <div class="page-pane" id="paneDonations">
        <table id="donationsTable" border="1">
            <thead>
                <tr>
                    <th>Member</th>
                    <th>Title</th>
...
<script src="app/Views/Circulation/logCirculation.js?v=3"></script>
</body>
</html>